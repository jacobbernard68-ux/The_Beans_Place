...
function LocationMap() {
  ...
  useEffect(() => {
    ...
    // Store the map so it survives re-renders and can b e controlled later
  ...
  return (
    ...
    // the flow of this component goes: empty div -> add imagery -> add a custom pin with a popup -> save it -> clean it up on exit
  );
}
...
export default function FooterSection() {
  return (
    <footer className="footer">
      <div className="mx-auto max-w-7x1 px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32 2xl:max-w-400">
        {/* Map */}
